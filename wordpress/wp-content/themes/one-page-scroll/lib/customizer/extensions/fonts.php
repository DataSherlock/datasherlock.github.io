...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'one-page-scroll' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'one-page-scroll' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'one-page-scroll' ),
		'cyrillic'     => __( 'Cyrillic', 'one-page-scroll' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'one-page-scroll' ),
		'devanagari'   => __( 'Devanagari', 'one-page-scroll' ),
		'greek'        => __( 'Greek', 'one-page-scroll' ),
		'greek-ext'    => __( 'Greek Extended', 'one-page-scroll' ),
		'khmer'        => __( 'Khmer', 'one-page-scroll' ),
		'latin'        => __( 'Latin', 'one-page-scroll' ),
		'latin-ext'    => __( 'Latin Extended', 'one-page-scroll' ),
		'vietnamese'   => __( 'Vietnamese', 'one-page-scroll' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'one-page-scroll' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'one-page-scroll' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'one-page-scroll' ),
