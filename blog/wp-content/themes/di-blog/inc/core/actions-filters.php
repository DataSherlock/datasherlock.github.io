...
function di_blog_admin_notice() {
	...
	if( ! get_user_meta( $user_id, 'di_blog_ignore_notice' ) ) {
		...
		printf( __( 'Thank you for activating Di Blog Theme. Let start from <a target="_blank" href="%1$s">Documentation</a> | <a target="_blank" href="%2$s">Visit Demo</a> | <a target="_blank" href="%3$s">Customize Now</a> | <a href="%4$s">Hide it</a>', 'di-blog' ), 'https://dithemes.com/di-blog-free-wordpress-theme-documentation/', 'http://demo.dithemes.com/di-blog/', esc_url( get_admin_url() . 'customize.php' ) , esc_url( add_query_arg( 'di_blog_notics_ignore', '0' ) ) );
