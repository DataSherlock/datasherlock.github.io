...
class Di_Blog_Engine {
	...
	public function setup() {
		...
		add_editor_style( array( '//fonts.googleapis.com/css?family=Raleway', get_template_directory_uri() . '/assets/css/bootstrap.css', get_template_directory_uri() . '/assets/css/style.css', get_template_directory_uri() . '/assets/css/editor-style.css' ) );
	}
	...
	public function scripts_and_styles() {
		...
		// Load bootstrap css.
		wp_enqueue_style( 'bootstrap', trailingslashit( get_template_directory_uri() ) . 'assets/css/bootstrap.css', array(), '3.3.7', 'all' );
		...
		// Load bootstrap js.
		wp_enqueue_script( 'bootstrap', trailingslashit( get_template_directory_uri() ) . 'assets/js/bootstrap.js', array( 'jquery' ), '3.3.7', true );
