...
if( class_exists( 'WooCommerce' ) ) {
	...
	Kirki::add_field( 'di_blog_config', array(
		...
		'section'     => 'woocommerce_options',
		'default'     => '<hr /><div style="padding: 10px;background-color: #333; color: #fff; border-radius: 8px;">' . esc_attr__( 'This layout will apply on Shop, Category, Single Product and Product Search Pages. For Cart, Checkout and My Account pages layout, use: Template option under Page Attribute on page edit screen.', 'di-blog' ) . '</div>',
	) );

	Kirki::add_field( 'di_blog_config', array(
		'type'        => 'radio-image',
		'settings'    => 'woo_layout',
		'label'       => esc_attr__( 'WooCommerce Page Layout', 'di-blog' ),
		'section'     => 'woocommerce_options',
		'default'     => 'fullw',
		'choices'     => array(
			'fullw'	  => get_template_directory_uri() . '/assets/images/fullw.png',
